    ...
    def get_memory_statistics(
        ...
        def traverse_node_memory(node: OperatorNode):
            ...
            if node not in self.processed_node:
                ...
                # since the node has not been visited for insert memory records, just ignore all children
                return
            elif is_op:
                ...
                for device, metrics in node_memory_metrics.items():
                    ...
                    # metrics is an array [SelfIncreaseSize, SelfAllocationSize, SelfAllocationCount]
