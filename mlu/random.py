...
def get_rng_state(device: int | str | torch.device = "mlu") -> Tensor:
    r"""Return the random number generator state of the specified MLU as a ByteTensor.
...
def set_rng_state(new_state: Tensor, device: int | str | torch.device = "mlu") -> None:
    r"""Set the random number generator state of the specified MLU.
    ...
    if not is_initialized():
        with torch._C._DisableFuncTorch():
            ...
            # later when MLU is lazy initialized.
...
def manual_seed(seed: int) -> None:
    r"""Set the seed for generating random numbers for the current MLU.
...
def manual_seed_all(seed: int) -> None:
    r"""Set the seed for generating random numbers on all MLUs.
...
def seed() -> None:
    r"""Set the seed for generating random numbers to a random number for the current MLU.
...
def seed_all() -> None:
    r"""Set the seed for generating random numbers to a random number on all MLUs.
...
def initial_seed() -> int:
    r"""Return the current random seed of the current MLU.
